...
public class AboutUs extends JFrame{
	...
	private JPanel contentPane;
        ...
        public AboutUs() {
            ...
            super("About Us - Rashrakavi Ramdhari Singh College Of Engineering");
            ...
            JLabel l6 = new JLabel("Developed By : Nishtha");
            l6.setFont(new Font("Trebuchet MS", Font.BOLD, 30));
            l6.setBounds(70, 198, 600, 35);
            contentPane.add(l6);

            JLabel l7 = new JLabel("Roll Number - 18105125014 ");
            l7.setFont(new Font("Trebuchet MS", Font.BOLD, 20));
            l7.setBounds(70, 260, 600, 34);
            contentPane.add(l7);

            JLabel l8 = new JLabel("Contact : nishthamishra189@gmail.com");
            ...
            JLabel l10 = new JLabel("Phone - +91 7484062305");
